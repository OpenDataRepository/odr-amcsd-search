...
class Odr_Rruff_Search_Admin {
    ...
    function odrRegisterSettings() {
        ...
        add_settings_field(
            'odr_search_background_color',
            'Search Box Background',
            array( $this, 'odr_search_background_color' ),
            $this->plugin_name,
            'field_settings'
        );
        add_settings_field(
            'odr_header_background_color',
            'Element Header Background',
            array( $this, 'odr_header_background_color' ),
            $this->plugin_name,
            'field_settings'
        );
        add_settings_field(
    ...
    function odr_search_background_color() {
        $options = get_option( 'odr_search_plugin_options' );
        echo "<input data-coloris id='odr_search_background_color' name='odr_search_plugin_options[background_color]' type='text' value='" . esc_attr( $options['background_color'] ) . "' />";
    }
    function odr_header_background_color() {
        $options = get_option( 'odr_search_plugin_options' );
        echo "<input data-coloris id='odr_header_background_color' name='odr_search_plugin_options[header_color]' type='text' value='" . esc_attr( $options['header_color'] ) . "' />";
    }
